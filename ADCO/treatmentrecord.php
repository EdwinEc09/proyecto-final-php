			...
			<td>&nbsp;<a href='treatmentfiles/$rs[uploads]' class='btn btn-sm btn-raised g-bg-cyan'>Descargar</a></td>
			 <td>&nbsp;$rs[treatment_date]</td>
			  <td>&nbsp;$rs[treatment_time]</td>
			    <td>&nbsp;$rs[status]</td>
          <td>&nbsp;
		  <a href='treatmentrecord.php?editid=$rs[appointmentid]&patientid=$_GET[patientid]&appid=$_GET[appid]'class='btn btn-sm btn-raised g-bg-cyan'>Editar</a><a href='treatmentrecord.php?delid=$rs[appointmentid]&patientid=$_GET[patientid]&appointmentid=$_GET[appid]'class='btn btn-sm btn-raised g-bg-blush2'>Eliminar</a> </td>
        </tr>";
        }
        ?>
      </tbody>
