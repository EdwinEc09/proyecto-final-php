...
<div class="wrapper col2">
	<div id="breadcrumb">
		<ul>
			<li class="first">Add Service Charge</li>
		</ul>
	</div>
</div>
		...
		<form method="post" action="" name="frmbill" onSubmit="return validateform()">
			...
			<table width="342" border="3">
				<tbody>
					<tr>
						<td width="34%">Date </td>
						<td width="66%"><input min="<?php echo date("Y-m-d"); ?>" value="<?php echo date("Y-m-d"); ?>"
			...
			<thead>
				<tr>
					<td colspan="2" align="center"><a
							href='patientreport.php?patientid=<?php echo $_GET['patientid']; ?>'><strong>View Patient
								Report>></strong></a></td>
				</tr>
			</thead>
		</table>
	...
	function validateform() {
		if (document.frmbill.treatment.value == "") {
			...
			Swal.fire({
				position: 'top-center',
				icon: 'error',
				title: 'tratamiento no debe ir vacio.',
