...
if (isset($_GET['delid'])) {
    if (isset($_GET['confirm']) && $_GET['confirm'] === 'true') {
        ...
        if (mysqli_affected_rows($con) == 1) {
            ...
            Swal.fire({
              title: 'Eliminado!',
              text: 'Se ha eliminado la prescripción con éxito',
              icon: 'success',
              showConfirmButton: false,
              timer:920
            }).then(function() {
                window.location.href = 'viewprescription.php'; // Redirige a la página deseada después de la eliminación
            });
            </script>";
        }
    } else {
        ...
        Swal.fire({
          ...
          confirmButtonText: 'Sí, eliminar'
            ...
            if (result.isConfirmed) {
                window.location.href = 'viewprescription.php?delid=" . $_GET['delid'] . "&confirm=true';
            } else {
