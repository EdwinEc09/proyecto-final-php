    ...
    <p>&nbsp;</p>
        ...
        echo "<tr>
          <td>&nbsp;$rstreatment[treatmenttype]</td>
			...
			<td>&nbsp;<a href='treatmentfiles/$rs[uploads]'>Descargar</a></td>
			 <td>&nbsp;$rs[treatment_date]</td>
			  <td>&nbsp;$rs[treatment_time]</td>
			    <td>&nbsp;$rs[status]</td>
          <td>&nbsp;
		  <a href='treatmentrecord.php?editid=$rs[appointmentid]&patientid=$_GET[patientid]&appid=$_GET[appid]'>Editar</a>| <a href='treatmentrecord.php?delid=$rs[appointmentid]&patientid=$_GET[patientid]&appointmentid=$_GET[appid]'>Eliminar</a> </td>
        </tr>";
		}
		?>
        </tbody>
