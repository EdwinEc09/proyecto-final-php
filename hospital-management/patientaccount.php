                ...
                <div class="card">
                    <div class="header">
                        <div class="alert bg-teal">
                            <h3>Bienvenido , <?php echo $rspatient['patientname']; ?>! </h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <div class="tab-content" style="padding: 10px">
                    <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1"
                        aria-expanded="true"> <b>Historial de registro</b>
                        <h3>Estás con nosotros desde el <?php echo $rspatient['admissiondate']; ?>
                            <?php echo $rspatient['admissiontime']; ?></h3>
                    </div>
                    <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1"
                        aria-expanded="false"> <b>Cita</b>
                        <?php
                        if(mysqli_num_rows($qsqlpatientappointment) == 0)
                        {
                            ?>
                        <h3>Registros de citas no encontrados..</h3>
                        <?php
                        }
                        else
                        {
