...
?>
  &nbsp;$ <?php echo $billamt; ?></td>
		...
		<tr>
		  <th scope="col"><div align="right">Motivo de descuento</div></th>
		...
		<tr>
		  <th scope="col"><div align="right">Monto de pago </div></th>
		  <td>$ <?php
		...
		<tr>
		  <th scope="col"><div align="right">Balance de Cuenta</div></th>
